<?php
	...
	{
		require "header.php";      //....User Logged in...// 	
	}
						...
						<div class="row">
							<div class="col-sm-4 col-12 pt-4">
								...
								<div class="input__box">
									...
									<input type="tel" id="id2" class="form-control" placeholder="5197814723" required>
								</div>
								<div class="input__box">
									<label>Pincode<span>*</span></label>
									<input type="text" id="id3" class="form-control" placeholder="N2R 0M3" required>
								</div>
								<div class="input__box">
									<label>Flat, House no. <span>*</span></label>
									<input type="text" id="id4" class="form-control" placeholder="54" required>
								</div>
								<div class="input__box">
									<label>Area<span>*</span></label>
									<input type="text" id="id5" class="form-control" placeholder="Pondcliffe Drive" required>
								</div>	
								<div class="input__box">
									<label>City<span>*</span></label>
									<input type="text" id="id6" class="form-control" placeholder="Kitchener" required>
								</div>
								<div class="input__box">
									<label>State<span>*</span></label>
									<input type="text" id="id7" class="form-control" placeholder="ON" required>
								</div>
							...
							<div class="col-sm-4 col-12 pt-4">
								...
								<div class="input__box">
									<label>Mobile No.<span>*</span></label>
									<input type="tel" id="id12" class="form-control" placeholder="5197814723" required>
								</div>
								<div class="input__box">
									<label>Pincode<span>*</span></label>
									<input type="text" id="id13" class="form-control" placeholder="N2R 0M3" required>
								</div>
								<div class="input__box">
									<label>Flat, House no. <span>*</span></label>
									<input type="text" id="id14" class="form-control" placeholder="54" required>
								</div>
								<div class="input__box">
									<label>Area<span>*</span></label>
									<input type="text" id="id15" class="form-control" placeholder="Pondcliffe Drive" required>
								</div>	
								<div class="input__box">
									<label>City<span>*</span></label>
									<input type="text" id="id16" class="form-control" placeholder="Kitchener" required>
								</div>
								<div class="input__box">
									<label>State<span>*</span></label>
									<input type="text" id="id17" class="form-control" placeholder="ON" required>
								</div>
	...
	$('#submit').click(function(){
		...
		else
		{
			$.ajax({
				...
				data:{action:'order',b_name:b_name,b_phone:b_phone,b_pincode:b_pincode,b_street:b_street,b_area:b_area,b_city:b_city,b_state:b_state,s_name:s_name,s_phone:s_phone,s_pincode:s_pincode,s_street:s_street,s_area:s_area,s_city:s_city,s_state:s_state},
